...
AS
  ...
  BEGIN
    ...
    FOR i IN 0 .. l_features.get_size - 1 LOOP
      ...
      IF (l_continent = 'Asia') THEN -- 'Asia' 'Africa' 'Europe' 'South America' 'Antarctica' 'Seven seas (open ocean)' 'Oceania' 'North America'
  ...
  BEGIN
    ...
    FOR i IN 0 .. l_features.get_size - 1 LOOP
      ...
      l_properties := treat(l_pais.get('properties') AS json_object_t);
      l_continent := l_properties.get_string('CONTINENT');
      IF (l_continent = 'Africa') THEN -- 'Asia' 'Africa' 'Europe' 'South America' 'Antarctica' 'Seven seas (open ocean)' 'Oceania' 'North America'
        l_geometry := treat(l_pais.get('geometry') AS json_object_t);
        l_type := l_geometry.get_string('type');
        l_coordinates := treat(l_geometry.get('coordinates') AS json_array_t);
        IF (l_type = 'Polygon') THEN
  ...
  BEGIN
    ...
    FOR i IN 0 .. l_features.get_size - 1 LOOP
      ...
      l_properties := treat(l_pais.get('properties') AS json_object_t);
      l_continent := l_properties.get_string('CONTINENT');
      IF (l_continent = 'Europe') THEN -- 'Asia' 'Africa' 'Europe' 'South America' 'Antarctica' 'Seven seas (open ocean)' 'Oceania' 'North America'
        l_geometry := treat(l_pais.get('geometry') AS json_object_t);
        l_type := l_geometry.get_string('type');
        l_coordinates := treat(l_geometry.get('coordinates') AS json_array_t);
        IF (l_type = 'Polygon') THEN
  ...
  BEGIN
    ...
    FOR i IN 0 .. l_features.get_size - 1 LOOP
      ...
      l_properties := treat(l_pais.get('properties') AS json_object_t);
      l_continent := l_properties.get_string('CONTINENT');
      IF (l_continent = 'South America') THEN -- 'Asia' 'Africa' 'Europe' 'South America' 'Antarctica' 'Seven seas (open ocean)' 'Oceania' 'North America'
        l_geometry := treat(l_pais.get('geometry') AS json_object_t);
        l_type := l_geometry.get_string('type');
        l_coordinates := treat(l_geometry.get('coordinates') AS json_array_t);
        IF (l_type = 'Polygon') THEN
  ...
  BEGIN
    ...
    FOR i IN 0 .. l_features.get_size - 1 LOOP
      ...
      l_properties := treat(l_pais.get('properties') AS json_object_t);
      l_continent := l_properties.get_string('CONTINENT');
      IF (l_continent = 'Antarctica') THEN -- 'Asia' 'Africa' 'Europe' 'South America' 'Antarctica' 'Seven seas (open ocean)' 'Oceania' 'North America'
        l_geometry := treat(l_pais.get('geometry') AS json_object_t);
        l_type := l_geometry.get_string('type');
        l_coordinates := treat(l_geometry.get('coordinates') AS json_array_t);
        IF (l_type = 'Polygon') THEN
  ...
  BEGIN
    ...
    FOR i IN 0 .. l_features.get_size - 1 LOOP
      ...
      l_properties := treat(l_pais.get('properties') AS json_object_t);
      l_continent := l_properties.get_string('CONTINENT');
      IF (l_continent = 'Seven seas (open ocean)') THEN -- 'Asia' 'Africa' 'Europe' 'South America' 'Antarctica' 'Seven seas (open ocean)' 'Oceania' 'North America'
        l_geometry := treat(l_pais.get('geometry') AS json_object_t);
        l_type := l_geometry.get_string('type');
        l_coordinates := treat(l_geometry.get('coordinates') AS json_array_t);
        IF (l_type = 'Polygon') THEN
  ...
  BEGIN
    ...
    FOR i IN 0 .. l_features.get_size - 1 LOOP
      ...
      l_properties := treat(l_pais.get('properties') AS json_object_t);
      l_continent := l_properties.get_string('CONTINENT');
      IF (l_continent = 'Oceania') THEN -- 'Asia' 'Africa' 'Europe' 'South America' 'Antarctica' 'Seven seas (open ocean)' 'Oceania' 'North America'
        l_geometry := treat(l_pais.get('geometry') AS json_object_t);
        l_type := l_geometry.get_string('type');
        l_coordinates := treat(l_geometry.get('coordinates') AS json_array_t);
        IF (l_type = 'Polygon') THEN
  ...
  BEGIN
    ...
    FOR i IN 0 .. l_features.get_size - 1 LOOP
      ...
      l_properties := treat(l_pais.get('properties') AS json_object_t);
      l_continent := l_properties.get_string('CONTINENT');
      IF (l_continent = 'North America') THEN -- 'Asia' 'Africa' 'Europe' 'South America' 'Antarctica' 'Seven seas (open ocean)' 'Oceania' 'North America'
        l_geometry := treat(l_pais.get('geometry') AS json_object_t);
        l_type := l_geometry.get_string('type');
        l_coordinates := treat(l_geometry.get('coordinates') AS json_array_t);
        IF (l_type = 'Polygon') THEN
